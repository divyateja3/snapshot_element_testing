...
test(`snapshot test on tablet`, async ({ page }) => {
    ...
    const skipElements = [
            ...
            // 'body > div > div.MuiContainer-root.rad-styles-5p4z2l > div > div.MuiContainer-root.MuiContainer-maxWidthXxl.MuiContainer-disableGutters.rad-styles-1mxoz86 > div > div > div > div',
            'body > div > div.MuiContainer-root.rad-styles-5p4z2l > div > div.MuiContainer-root.MuiContainer-maxWidthXxl.MuiContainer-disableGutters.rad-styles-1mxoz86 > div > div > div > div > div:nth-child(2) > a > p',
            'body > div > div.MuiContainer-root.rad-styles-5p4z2l > div > div.MuiContainer-root.MuiContainer-maxWidthXxl.MuiContainer-disableGutters.rad-styles-1mxoz86 > div > div > div > div > div:nth-child(3) > a > p',
            'body > div > div.MuiContainer-root.rad-styles-5p4z2l > div > div.MuiContainer-root.MuiContainer-maxWidthXxl.MuiContainer-disableGutters.rad-styles-1mxoz86 > div > div > div > div > div:nth-child(4) > a > p',
            'body > div > div.MuiContainer-root.rad-styles-5p4z2l > div > div.MuiContainer-root.MuiContainer-maxWidthXxl.MuiContainer-disableGutters.rad-styles-1mxoz86 > div > div > div > div > div:nth-child(5) > a > p',
